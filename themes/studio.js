...
registry.add({
    ...
    name: 'Studio',
    vars: {
        '--metaviz-logo-save': 'rgb(0, 214, 252)',
        '--canvas-bg-color': 'rgb(30, 30, 30)',
        '--front-color': 'rgb(255, 255, 255)',
        '--front-color-reverse': 'rgb(40, 40, 40)',
        '--node-icon': 'rgb(0, 214, 252)',
        '--node-icon-subtitle': 'rgb(220, 220, 220)',
        ...
        '--metaviz-color-cyan': 'rgb(0, 214, 252)',
        '--metaviz-color-cyan-trans': 'rgba(0, 214, 252, 0.69)',
